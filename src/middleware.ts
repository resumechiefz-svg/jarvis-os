...
const PUBLIC_ROUTES = ['/api/push', '/api/auth', '/api/news', '/api/stocks', '/api/google/auth', '/api/google/callback', '/api/siri', '/api/linkedin/auth', '/api/linkedin/callback', '/api/watch', '/api/strava/callback', '/api/strava/health']
